Swal.fire({
    ...
    text: "Esta es el Completa de dificultad media añadiendo las valencias / número de oxidación. ¿Preparado?",
    ...
    (async () => {
        ...
        if (simbolo === "Os" && elemento === "Osmio) {
            Swal.fire({
                ...
                icon: "success",
                confirmButtonText: "Siguiente"
            }); document.getElementById("Os").style.border = "3px #77dd77 solid"; document.getElementById("Os").innerHTML = "Os"; document.getElementById("Os").title = "Osmio"; document.getElementById("Os").style.backgroundColor = "#ffddb3"; document.getElementById("Os").style.pointerEvents = "none";
        }
        else {
            Swal.fire({
                title: "Incorrecto...",
